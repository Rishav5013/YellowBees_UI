    ...
    <HireSectionStyle>
      <>
        <Heading
          ...
          lineHeight={2}
        >
          Hire through Yellowbees.io with simple steps
        </Heading>
      </>
      ...
      <HireStepsStyle>
        ...
        <ParentImageDiv>
          <ImageWrapper src="/images/Hirebg.svg" alt="dottet Line" size="ssl" />
        </ParentImageDiv>
        ...
        <HireSteps
          ...
          alt="hire image 2"
          size="lg"
          txt="Account Manager Assist You"
          height="5.2rem"
          width="5.2rem"
        />
        <HireSteps
          ...
          alt="hire image 3"
          size="lg"
          txt="Assess & Shortlisting The Candidates"
          height="5.2rem"
          width="5.2rem"
        />
        <HireSteps
